    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagement(string userId)
        {
            RoleManagementVM RoleVM = new RoleManagementVM()
            {
                ...
                RoleList = (IEnumerable<System.Web.Mvc.SelectListItem>)_roleManager.Roles.Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Name
                }),
        ...
        //    {
        //        //a role was updated
        //        if (roleManagementVM.ApplicationUser.Role == SD.Role_Staff)
        //        {
        ...
        public IActionResult GetAll()
        {
            ...
            //var userRoles = _unitOfWork.ApplicationUser.GetAll(u => u.Role == SD.Role_Admin).ToList();
